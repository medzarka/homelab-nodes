#!/usr/bin/env bash
# ==============================================================================
# Homelab Node Framework — Worker Node Initializer & Hardener
# ==============================================================================
# Automates the entire bootstrap lifecycle for a Homelab Worker Node:
...
# 6. Tailscale VPN Mesh + Arcane Agent Deployment
# 7. Docker Swarm Worker Cluster Join (over Tailscale Mesh)
# ==============================================================================
...
echo "===================================================================="
echo "          🛠️ HOMELAB WORKER NODE INITIALIZER & HARDENER            "
echo "===================================================================="
print_system_info
...
# ------------------------------------------------------------------------------
# 8. Completion Summary & Auditing
# ------------------------------------------------------------------------------
echo ""
echo "===================================================================="
echo "🎉 WORKER NODE SETUP & HARDENING COMPLETED SUCCESSFULLY!"
echo "===================================================================="
...
echo "    sudo ./audit-node.sh --role worker"
echo "===================================================================="
