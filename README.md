...
**Prompts / Variables needed:**
- **Master Tailscale IP** (e.g., `100.x.y.1`)
- **Arcane Agent Token** (from Arcane Manager UI $\rightarrow$ **Nodes** $\rightarrow$ **Add Node**)
- **Swarm Worker Join Token** (generated by `setup-master.sh`)
